...
$co =0;
 foreach($f_ar as $k => $v){
	 $MyData ->addPoints($v['y'], $k);
	  ...
	  $MyData->setScatterSerieDescription($co-1,"Percentile $k"); 
	  $MyData->setScatterSerieWeight($co-1, 2);
	  $MyData->setSerieOnAxis("X", 0);
 ...
 $MyData->setScatterSerieWeight(114,3);
...
//$myPicture = new pImage(400,400,$MyData); 
 ...
 $myPicture = new pImage(900,900,$MyData); 

 /* Draw the background */ 
 $Settings = array("R"=>170, "G"=>183, "B"=>87, "Dash"=>1, "DashR"=>190, "DashG"=>203, "DashB"=>107); 
 $myPicture->drawFilledRectangle(0,0,900,900,$Settings); 

 /* Overlay with a gradient */ 
 $Settings = array("StartR"=>219, "StartG"=>231, "StartB"=>139, "EndR"=>1, "EndG"=>138, "EndB"=>68, "Alpha"=>50); 
 $myPicture->drawGradientArea(0,0,900,900,DIRECTION_VERTICAL,$Settings); 
...
$myScatter->drawScatterLineChart();
 ...
 /* Draw the legend */ 
 $myScatter->drawScatterLegend(80,880,array("Mode"=>LEGEND_HORIZONTAL,"Style"=>LEGEND_NOBORDER)); 
